...
plugins=(git zsh-syntax-highlighting zsh-completions zsh-autosuggestions fzf-tab zsh-vi-mode z sudo command-not-found zsh-history-substring-search web-search copyfile exercism)
